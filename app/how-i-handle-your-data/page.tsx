        ...
        <div className="text-left space-y-6">
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>Technical specifications and access credentials (when necessary)</li>
          ...
          <section>
            ...
            <p className="mb-4">
              Your data security is my top priority:
            </p>
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>Data is never shared with third parties without explicit consent</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>Project data is retained for the duration of our engagement</li>
              <li>Contact information is kept for future communication unless you opt out</li>
              <li>Payment records are retained for tax and legal compliance</li>
              <li>All data can be deleted upon request after project completion</li>
            </ul>
          </section>
        </div>
