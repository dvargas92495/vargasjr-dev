...
export default function TestButton({ workflowDeploymentName, disabled = false }: TestButtonProps) {
  ...
  const handleTest = async () => {
    ...
    try {
      const eventSource = new EventSource(`/api/vellum/workflow-deployments/${workflowDeploymentName}/test-stream`);
