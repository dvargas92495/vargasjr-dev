...
class AgentPublisher {
  ...
  async run(): Promise<void> {
    ...
    try {
      ...
      execSync(`cp -r vellum/models ${packageName}/models`, { stdio: 'inherit' });
      execSync(`cp -r vellum/services ${packageName}/services`, { stdio: 'inherit' });
      execSync(`cp -r vellum/workflows ${packageName}/workflows`, { stdio: 'inherit' });
      execSync(`cp vellum/pyproject.toml ${packageName}/pyproject.toml`, { stdio: 'inherit' });
